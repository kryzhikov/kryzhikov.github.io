![Титульный лист](media/title_page.png)
...
### Данные 
1. Данные о самих акциях, собранные с помощью qlib + Alpha360 
   1. Цена открытия 
   2. Цена закрытия 
   3. Максимальная цена за день
   4. Минимальная цена за день
   5. Суммарный объём 
   6. Средневзвешенный объём на каждом уровне в стакане 
2. Высокоуровневые концепты
   1. Авторы статьи собрали данные для CSI 100 и CSI 300 о самих акциях  с сайта https://tushare.pro/, 410 высокоуровневых признаков для каждого дня для каждой акции. Посмотреть можно [здесь](https://github.com/kryzhikov/kryzhikov.github.io/blob/main/data/csi300_stock2concept.npy)
