...
2. Высокоуровневые концепты
   1. Авторы статьи собрали данные для CSI 100 и CSI 300 о самих акциях  с сайта https://tushare.pro/, 410 высокоуровневых признаков для каждого дня для каждой акции 
